...
import {
  DollarSign, Eye, Edit2, Printer, Ban, Plus, RefreshCw,
        ...
        <tr key={r.id}>
          ...
          <td>
            <div className="row-actions exc-actions-grid">
              <button className="icon-btn view" title="Ver detalles" onClick={() => onView(r)}><Eye size={14} /></button>
              <button className="icon-btn edit" title="Editar" onClick={() => onEdit(r)}><Edit2 size={14} /></button>
...
export const ReciboDetallesModal: React.FC<DetallesProps> = ({ recibo, onClose }) => (
  <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
    <div className="resolucion-modal exc-detalles-modal">
...
export const ReciboEditModal: React.FC<EditProps> = ({ isEdit, form, onFormChange, onClose, onSave }) => (
  <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
    <div className="resolucion-modal exc-editar-modal">
      <div className="resolucion-modal-header">
        <h2 className="resolucion-modal-title">
          <DollarSign size={17} style={{ marginRight: 8, verticalAlign: 'middle' }} />
          {isEdit ? 'Editar Recibo de Pago' : 'Nuevo Recibo de Pago'}
        </h2>
        <button className="resolucion-modal-close" onClick={onClose}><X size={18} /></button>
      </div>
