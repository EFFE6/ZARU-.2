...
const CancelarOrdenes: React.FC = () => {
  ...
  return (
    <div style={{ padding: '0 4px' }}>
      ...
      <div className="cancel-warning-banner-premium">
        <div className="cancel-warning-icon-box">
          <AlertTriangle size={20} color="#d97706" />
        </div>
        <div className="cancel-warning-content">
          <span className="cancel-warning-title">Atención: Esta acción es irreversible</span>
          <span className="cancel-warning-text">Una vez cancelada, la orden no podrá ser reactivada en el sistema. Asegúrese de que el número de orden sea el correcto antes de proceder.</span>
        </div>
      </div>
