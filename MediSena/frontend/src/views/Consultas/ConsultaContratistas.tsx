...
import {
  Building2, Search, Filter, Eye, Printer, Info, X, Mail, Phone,
} from 'lucide-react';
        ...
        <tr key={c.id}>
          ...
          <td>
            <div className="row-actions">
              <button className="icon-btn view" title="Ver contratista" onClick={() => onView(c)}>
                <Eye size={15} />
              </button>
            </div>
          </td>
    ...
    <div className="resolucion-modal cons-detalles-modal">
      <div className="resolucion-modal-header">
        <h2 className="resolucion-modal-title">
          <Building2 size={17} style={{ marginRight: 8, verticalAlign: 'middle' }} />
