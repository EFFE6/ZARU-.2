...
import {
  FileText, User, Calendar, Search, Filter, Printer,
  Info, X, Stethoscope,
} from 'lucide-react';
        ...
        <tr key={o.id}>
          ...
          <td>
            <div className="row-actions">
              <button className="db-icon-btn-svg" title="Ver detalles" onClick={() => onView(o)}>
...
export const OrdenConsultaDetallesModal: React.FC<DetallesProps> = ({ orden, onClose }) => (
  <Modal isOpen={true} onClose={onClose} title="Detalles de la Orden" className="cons-detalles-modal">
